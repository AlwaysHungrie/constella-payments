...
export default function PaymentModal({
  ...
  const [step, setStep] = useState<'initial' | 'payment' | 'complete'>(
    'initial'
  )
          ...
          {step === 'payment' && paymentRequest && (
            <div className="space-y-2">
              <div className="text-left">
                <p className="text-gray-600 font-sans">
                  Send the exact amount in USDC on Scroll to complete your
                  purchase
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-r from-amber-50 to-amber-100 rounded-xl p-2 border border-amber-200">
                  <div className="text-center">
                    <p className="text-sm font-serif text-amber-700 mb-1">
                      Total Amount
                    </p>
                    <p className="text-2xl font-sans text-amber-900">
                      ${price}
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      onClick={() =>
                        copyToClipboard(paymentRequest.walletAddress)
                      }
                ...
                <div className="rounded-xl p-4">
                  <div className="space-y-3">
                    <h3 className="font-medium text-gray-900 font-sans text-sm">
                      Payment Instructions
                    </h3>
                    <ol className="text-sm text-gray-700 space-y-2 font-sans">
                      <li className="flex items-start space-x-2">
                        <span className="flex-shrink-0 w-4 h-4 bg-gray-200 rounded-full flex items-center justify-center text-xs font-medium text-gray-700">
                          1
                        </span>
                      ...
                      <li className="flex items-start space-x-2">
                        ...
                        <span>
                          Send exactly <strong>{price} USDC</strong> on Scroll
                          network
                        </span>
                      </li>
                      <li className="flex items-start space-x-2">
                      ...
                      <li className="flex items-start space-x-2">
                        ...
                        <span>
                          Click &ldquo;Complete Payment&rdquo; to verify
                        </span>
                      </li>
                    </ol>
                  </div>
                  ...
                  <div className="flex items-start space-x-2">
                    <div>
                      ...
                      <p className="text-xs text-red-600 font-sans mt-1">
                        Only send USDC on Scroll network. Funds sent on other
                        chains or tokens will be lost forever.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-gray-600 font-sans leading-relaxed text-sm">
                  Thank you for your purchase. Your artwork will be carefully
                  packaged and shipped to you within 3-5 business days.
                </p>
